...
namespace eval ::optrace {
  variable script "C:/v23.1/FEB_test/FEB_test.runs/synth_1/Test_DDR_wrapper.tcl"
...
read_vhdl -library xil_defaultlib c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/hdl/Test_DDR_wrapper.vhd
...
synth_design -top Test_DDR_wrapper -part xc7s50fgga484-2
...
write_checkpoint -force -noxdef Test_DDR_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Test_DDR_wrapper_utilization_synth.rpt -pb Test_DDR_wrapper_utilization_synth.pb"
