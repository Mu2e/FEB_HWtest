...
namespace eval ::optrace {
  variable script "C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1.tcl"
...
OPTRACE "Test_DDR_axi_smc_1_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet c:/v23.1/FEB_test/FEB_test.srcs/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1.xci
...
set cacheID [config_ip_cache -export -no_bom  -dir C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1 -new_name Test_DDR_axi_smc_1 -ip [get_ips Test_DDR_axi_smc_1]]
...
synth_design -top Test_DDR_axi_smc_1 -part xc7s50fgga484-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix Test_DDR_axi_smc_1_ Test_DDR_axi_smc_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Test_DDR_axi_smc_1_stub.v
 lappend ipCachedFiles Test_DDR_axi_smc_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Test_DDR_axi_smc_1_stub.vhdl
 lappend ipCachedFiles Test_DDR_axi_smc_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Test_DDR_axi_smc_1_sim_netlist.v
 lappend ipCachedFiles Test_DDR_axi_smc_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Test_DDR_axi_smc_1_sim_netlist.vhdl
 lappend ipCachedFiles Test_DDR_axi_smc_1_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp Test_DDR_axi_smc_1.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips Test_DDR_axi_smc_1]
 }
...
rename_ref -prefix_all Test_DDR_axi_smc_1_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Test_DDR_axi_smc_1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "Test_DDR_axi_smc_1_synth_1_synth_report_utilization_0" "report_utilization -file Test_DDR_axi_smc_1_utilization_synth.rpt -pb Test_DDR_axi_smc_1_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1.dcp c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1_stub.v c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1_stub.vhdl c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1_sim_netlist.v c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/v23.1/FEB_test/FEB_test.runs/Test_DDR_axi_smc_1_synth_1/Test_DDR_axi_smc_1_sim_netlist.vhdl c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/v23.1/FEB_test/FEB_test.ip_user_files/ip/Test_DDR_axi_smc_1]} {
  catch { 
    file copy -force c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.v C:/v23.1/FEB_test/FEB_test.ip_user_files/ip/Test_DDR_axi_smc_1
  }
}

if {[file isdir C:/v23.1/FEB_test/FEB_test.ip_user_files/ip/Test_DDR_axi_smc_1]} {
  catch { 
    file copy -force c:/v23.1/FEB_test/FEB_test.gen/sources_1/bd/Test_DDR/ip/Test_DDR_axi_smc_1/Test_DDR_axi_smc_1_stub.vhdl C:/v23.1/FEB_test/FEB_test.ip_user_files/ip/Test_DDR_axi_smc_1
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "Test_DDR_axi_smc_1_synth_1" END { }
